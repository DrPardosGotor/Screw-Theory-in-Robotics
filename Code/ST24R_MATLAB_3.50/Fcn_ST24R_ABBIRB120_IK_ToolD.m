...
%
%% Fcn_ST24R_ABBIRB120_IK_ToolD
%
function ThetaSET = Fcn_ST24R_ABBIRB120_IK_ToolD(u) %#codegen
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
