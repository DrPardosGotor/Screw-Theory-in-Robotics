...
% DHC Denavit-Hartenberg CLASSIC solution DIRECT SOLUTION.
%
...
%
%% Hdh = BodyDHC2tformD(dhparams)
%
function Hdh = BodyDHC2tformD(dhparams)
%
    d = dhparams(1);
    t = dhparams(2);
    r = dhparams(3);
    ...
    ca = cos(a);
    sa = sin(a); 
    Hdh = [ct -ca*st sa*st r*ct; st ca*ct -sa*ct r*st; 0 sa ca d; 0 0 0 1];
end
%
