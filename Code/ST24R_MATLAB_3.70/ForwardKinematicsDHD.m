%% FORWARDKINEMATICSDH Forward Kinematics Rigid Body Tree by D-H parameters
% D-H for Denavit-Hartenberg
% Direct calculation of the D-H Joint Matrix.
%
...
%
%   H = FORWARDKINEMATICSDHD(DHPARAMS) gets the homogeneous matrix H for 
...
%
function Hst = ForwardKinematicsDHD(dhparams)
%
    Hst = BodyDHC2tformD(dhparams(1,:));  
    for i = 2:size(dhparams,1)
        Hst = Hst*BodyDHC2tformD(dhparams(i,:));
    end
end
%
