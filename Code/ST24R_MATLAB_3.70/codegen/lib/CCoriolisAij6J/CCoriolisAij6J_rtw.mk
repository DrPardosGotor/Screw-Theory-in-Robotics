###########################################################################
## Makefile generated for component 'CCoriolisAij6J'. 
## 
## Makefile     : CCoriolisAij6J_rtw.mk
## Generated on : Wed Nov 11 15:20:40 2020
## Final product: ./CCoriolisAij6J.a
...
PRODUCT_NAME              = CCoriolisAij6J
MAKEFILE                  = CCoriolisAij6J_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dr.josem.pardos-gotor/Documents/MATLAB/2020_Pardos-Gotor_ST24R_MATLAB_v37/codegen/lib/CCoriolisAij6J
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=CCoriolisAij6J
...
SRCS = $(START_DIR)/CCoriolisAij6J_data.cpp $(START_DIR)/rt_nonfinite.cpp $(START_DIR)/rtGetNaN.cpp $(START_DIR)/rtGetInf.cpp $(START_DIR)/CCoriolisAij6J_initialize.cpp $(START_DIR)/CCoriolisAij6J_terminate.cpp $(START_DIR)/CCoriolisAij6J.cpp $(START_DIR)/Christoffel.cpp $(START_DIR)/expScrew.cpp $(START_DIR)/mldivide.cpp
...
OBJS = CCoriolisAij6J_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o CCoriolisAij6J_initialize.o CCoriolisAij6J_terminate.o CCoriolisAij6J.o Christoffel.o expScrew.o mldivide.o
...
CCoriolisAij6J_data.o : $(START_DIR)/CCoriolisAij6J_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
CCoriolisAij6J_initialize.o : $(START_DIR)/CCoriolisAij6J_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CCoriolisAij6J_terminate.o : $(START_DIR)/CCoriolisAij6J_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CCoriolisAij6J.o : $(START_DIR)/CCoriolisAij6J.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Christoffel.o : $(START_DIR)/Christoffel.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
