...
#include "CCoriolisAij6J_terminate.h"
...
static void main_CCoriolisAij6J();
...
static void main_CCoriolisAij6J()
{
  ...
  // Initialize function 'CCoriolisAij6J' input arguments.
  ...
  // Call the entry-point 'CCoriolisAij6J'.
  argInit_1x6_real_T(dv);
  CCoriolisAij6J(TwMag_tmp, TwMag_tmp, dv, Ctdt);
}
