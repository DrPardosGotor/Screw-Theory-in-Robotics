###########################################################################
## Makefile generated for component 'CCoriolisAij7J'. 
## 
## Makefile     : CCoriolisAij7J_rtw.mk
## Generated on : Sun Nov 15 13:46:19 2020
## Final product: ./CCoriolisAij7J.a
...
PRODUCT_NAME              = CCoriolisAij7J
MAKEFILE                  = CCoriolisAij7J_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dr.josem.pardos-gotor/Documents/MATLAB/2020_Pardos-Gotor_ST24R_MATLAB_v37/codegen/lib/CCoriolisAij7J
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=CCoriolisAij7J
...
SRCS = $(START_DIR)/CCoriolisAij7J_data.cpp $(START_DIR)/rt_nonfinite.cpp $(START_DIR)/rtGetNaN.cpp $(START_DIR)/rtGetInf.cpp $(START_DIR)/CCoriolisAij7J_initialize.cpp $(START_DIR)/CCoriolisAij7J_terminate.cpp $(START_DIR)/CCoriolisAij7J.cpp $(START_DIR)/Christoffel.cpp $(START_DIR)/expScrew.cpp $(START_DIR)/mldivide.cpp
...
OBJS = CCoriolisAij7J_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o CCoriolisAij7J_initialize.o CCoriolisAij7J_terminate.o CCoriolisAij7J.o Christoffel.o expScrew.o mldivide.o
...
CCoriolisAij7J_data.o : $(START_DIR)/CCoriolisAij7J_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
CCoriolisAij7J_initialize.o : $(START_DIR)/CCoriolisAij7J_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CCoriolisAij7J_terminate.o : $(START_DIR)/CCoriolisAij7J_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CCoriolisAij7J.o : $(START_DIR)/CCoriolisAij7J.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
