###########################################################################
## Makefile generated for component 'MInertiaJsl4J'. 
## 
## Makefile     : MInertiaJsl4J_rtw.mk
## Generated on : Sat Nov 14 15:58:52 2020
## Final product: ./MInertiaJsl4J.a
...
PRODUCT_NAME              = MInertiaJsl4J
MAKEFILE                  = MInertiaJsl4J_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dr.josem.pardos-gotor/Documents/MATLAB/2020_Pardos-Gotor_ST24R_MATLAB_v37/codegen/lib/MInertiaJsl4J
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=MInertiaJsl4J
...
SRCS = $(START_DIR)/MInertiaJsl4J_data.cpp $(START_DIR)/MInertiaJsl4J_initialize.cpp $(START_DIR)/MInertiaJsl4J_terminate.cpp $(START_DIR)/MInertiaJsl4J.cpp $(START_DIR)/expScrew.cpp $(START_DIR)/xgetrf.cpp
...
OBJS = MInertiaJsl4J_data.o MInertiaJsl4J_initialize.o MInertiaJsl4J_terminate.o MInertiaJsl4J.o expScrew.o xgetrf.o
...
MInertiaJsl4J_data.o : $(START_DIR)/MInertiaJsl4J_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MInertiaJsl4J_initialize.o : $(START_DIR)/MInertiaJsl4J_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MInertiaJsl4J_terminate.o : $(START_DIR)/MInertiaJsl4J_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MInertiaJsl4J.o : $(START_DIR)/MInertiaJsl4J.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
