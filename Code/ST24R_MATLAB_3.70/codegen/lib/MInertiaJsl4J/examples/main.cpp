...
#include "MInertiaJsl4J_terminate.h"

// Function Declarations
static void argInit_7x4_real_T(double result[28]);
static double argInit_real_T();
static void main_MInertiaJsl4J();
...
static void main_MInertiaJsl4J()
{
  ...
  // Initialize function 'MInertiaJsl4J' input arguments.
  // Initialize function input argument 'TwMag'.
  argInit_7x4_real_T(TwMag_tmp);

  // Initialize function input argument 'LiMas'.
  // Call the entry-point 'MInertiaJsl4J'.
  MInertiaJsl4J(TwMag_tmp, TwMag_tmp, Mt);
}
