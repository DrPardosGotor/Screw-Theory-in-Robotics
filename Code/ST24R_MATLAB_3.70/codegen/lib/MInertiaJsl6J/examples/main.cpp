...
#include "MInertiaJsl6J_terminate.h"

// Function Declarations
static void argInit_7x6_real_T(double result[42]);
static double argInit_real_T();
static void main_MInertiaJsl6J();
...
static void main_MInertiaJsl6J()
{
  ...
  // Initialize function 'MInertiaJsl6J' input arguments.
  // Initialize function input argument 'TwMag'.
  argInit_7x6_real_T(TwMag_tmp);

  // Initialize function input argument 'LiMas'.
  // Call the entry-point 'MInertiaJsl6J'.
  MInertiaJsl6J(TwMag_tmp, TwMag_tmp, Mt);
}
