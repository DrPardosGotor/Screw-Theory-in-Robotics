###########################################################################
## Makefile generated for component 'MInertiaJsl7J'. 
## 
## Makefile     : MInertiaJsl7J_rtw.mk
## Generated on : Sun Nov 15 13:44:24 2020
## Final product: ./MInertiaJsl7J.a
...
PRODUCT_NAME              = MInertiaJsl7J
MAKEFILE                  = MInertiaJsl7J_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dr.josem.pardos-gotor/Documents/MATLAB/2020_Pardos-Gotor_ST24R_MATLAB_v37/codegen/lib/MInertiaJsl7J
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=MInertiaJsl7J
...
SRCS = $(START_DIR)/MInertiaJsl7J_data.cpp $(START_DIR)/MInertiaJsl7J_initialize.cpp $(START_DIR)/MInertiaJsl7J_terminate.cpp $(START_DIR)/MInertiaJsl7J.cpp $(START_DIR)/expScrew.cpp $(START_DIR)/xgetrf.cpp
...
OBJS = MInertiaJsl7J_data.o MInertiaJsl7J_initialize.o MInertiaJsl7J_terminate.o MInertiaJsl7J.o expScrew.o xgetrf.o
...
MInertiaJsl7J_data.o : $(START_DIR)/MInertiaJsl7J_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MInertiaJsl7J_initialize.o : $(START_DIR)/MInertiaJsl7J_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MInertiaJsl7J_terminate.o : $(START_DIR)/MInertiaJsl7J_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MInertiaJsl7J.o : $(START_DIR)/MInertiaJsl7J.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
