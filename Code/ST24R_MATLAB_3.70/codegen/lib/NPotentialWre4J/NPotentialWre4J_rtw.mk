###########################################################################
## Makefile generated for component 'NPotentialWre4J'. 
## 
## Makefile     : NPotentialWre4J_rtw.mk
## Generated on : Sat Nov 14 16:04:50 2020
## Final product: ./NPotentialWre4J.a
...
PRODUCT_NAME              = NPotentialWre4J
MAKEFILE                  = NPotentialWre4J_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dr.josem.pardos-gotor/Documents/MATLAB/2020_Pardos-Gotor_ST24R_MATLAB_v37/codegen/lib/NPotentialWre4J
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=NPotentialWre4J
...
SRCS = $(START_DIR)/NPotentialWre4J_data.c $(START_DIR)/NPotentialWre4J_initialize.c $(START_DIR)/NPotentialWre4J_terminate.c $(START_DIR)/NPotentialWre4J.c $(START_DIR)/expScrew.c
...
OBJS = NPotentialWre4J_data.o NPotentialWre4J_initialize.o NPotentialWre4J_terminate.o NPotentialWre4J.o expScrew.o
...
NPotentialWre4J_data.o : $(START_DIR)/NPotentialWre4J_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NPotentialWre4J_initialize.o : $(START_DIR)/NPotentialWre4J_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NPotentialWre4J_terminate.o : $(START_DIR)/NPotentialWre4J_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NPotentialWre4J.o : $(START_DIR)/NPotentialWre4J.c
	$(CC) $(CFLAGS) -o "$@" "$<"
