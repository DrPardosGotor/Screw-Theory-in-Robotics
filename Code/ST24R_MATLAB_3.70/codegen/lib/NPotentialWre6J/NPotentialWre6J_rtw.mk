###########################################################################
## Makefile generated for component 'NPotentialWre6J'. 
## 
## Makefile     : NPotentialWre6J_rtw.mk
## Generated on : Wed Nov 11 15:21:47 2020
## Final product: ./NPotentialWre6J.a
...
PRODUCT_NAME              = NPotentialWre6J
MAKEFILE                  = NPotentialWre6J_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dr.josem.pardos-gotor/Documents/MATLAB/2020_Pardos-Gotor_ST24R_MATLAB_v37/codegen/lib/NPotentialWre6J
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=NPotentialWre6J
...
SRCS = $(START_DIR)/NPotentialWre6J_data.cpp $(START_DIR)/NPotentialWre6J_initialize.cpp $(START_DIR)/NPotentialWre6J_terminate.cpp $(START_DIR)/NPotentialWre6J.cpp $(START_DIR)/expScrew.cpp
...
OBJS = NPotentialWre6J_data.o NPotentialWre6J_initialize.o NPotentialWre6J_terminate.o NPotentialWre6J.o expScrew.o
...
NPotentialWre6J_data.o : $(START_DIR)/NPotentialWre6J_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


NPotentialWre6J_initialize.o : $(START_DIR)/NPotentialWre6J_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


NPotentialWre6J_terminate.o : $(START_DIR)/NPotentialWre6J_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


NPotentialWre6J.o : $(START_DIR)/NPotentialWre6J.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
