###########################################################################
## Makefile generated for component 'NPotentialWre7J'. 
## 
## Makefile     : NPotentialWre7J_rtw.mk
## Generated on : Sun Nov 15 13:47:46 2020
## Final product: ./NPotentialWre7J.a
...
PRODUCT_NAME              = NPotentialWre7J
MAKEFILE                  = NPotentialWre7J_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2020b.app
MATLAB_BIN                = /Applications/MATLAB_R2020b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dr.josem.pardos-gotor/Documents/MATLAB/2020_Pardos-Gotor_ST24R_MATLAB_v37/codegen/lib/NPotentialWre7J
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=NPotentialWre7J
...
SRCS = $(START_DIR)/NPotentialWre7J_data.cpp $(START_DIR)/NPotentialWre7J_initialize.cpp $(START_DIR)/NPotentialWre7J_terminate.cpp $(START_DIR)/NPotentialWre7J.cpp $(START_DIR)/expScrew.cpp
...
OBJS = NPotentialWre7J_data.o NPotentialWre7J_initialize.o NPotentialWre7J_terminate.o NPotentialWre7J.o expScrew.o
...
NPotentialWre7J_data.o : $(START_DIR)/NPotentialWre7J_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


NPotentialWre7J_initialize.o : $(START_DIR)/NPotentialWre7J_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


NPotentialWre7J_terminate.o : $(START_DIR)/NPotentialWre7J_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


NPotentialWre7J.o : $(START_DIR)/NPotentialWre7J.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
