...
// Include Files
#include "main.h"
#include "NPotentialWre7J.h"
#include "NPotentialWre7J_terminate.h"

// Function Declarations
static void argInit_3x1_real_T(double result[3]);
static void argInit_7x7_real_T(double result[49]);
static double argInit_real_T();
static void main_NPotentialWre7J();
...
static void main_NPotentialWre7J()
{
  ...
  // Initialize function 'NPotentialWre7J' input arguments.
  ...
  // Call the entry-point 'NPotentialWre7J'.
  argInit_3x1_real_T(dv);
  NPotentialWre7J(TwMag_tmp, TwMag_tmp, dv, Nt);
}
...
int main(int, const char * const [])
{
  ...
  main_NPotentialWre7J();

  // Terminate the application.
  // You do not need to do this more than one time.
  NPotentialWre7J_terminate();
  return 0;
}
