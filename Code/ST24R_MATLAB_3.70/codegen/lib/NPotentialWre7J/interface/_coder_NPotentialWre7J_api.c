 ...
 * File: _coder_NPotentialWre7J_api.c
 *
...
/* Include Files */
#include "_coder_NPotentialWre7J_api.h"
#include "_coder_NPotentialWre7J_mex.h"
  ...
  void NPotentialWre7J_api(const mxArray * const prhs[3], const mxArray *plhs[1])
{
  ...
  Nt = (real_T (*)[7])mxMalloc(sizeof(real_T [7]));
  ...
  NPotentialWre7J(*TwMag, *LiMas, *PoAcc, *Nt);
...
void NPotentialWre7J_atexit(void)
{
  ...
  NPotentialWre7J_xil_terminate();
  NPotentialWre7J_xil_shutdown();
...
/*
 * File trailer for _coder_NPotentialWre7J_api.c
 *
 * [EOF]
 */
