%% Screw Theory for Robotics - FORWARD Kinematics - Exercise_41.
% PUMA robot - ABB IRB120 - ToolUp configuration.
%
...
%
%% E332_ST24R_FK_ABBIRB120_POE_ToolUp
%
clear
clc
...
Hst0 = trvP2tform(pp)*rotX2tform(-pi/2);
%
Mag = [0 0 0 0 0 0];
for i = 1:6
