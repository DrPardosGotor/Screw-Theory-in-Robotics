%% Screw Theory - INVERSE DYNAMICS - ABB IRB120.
...
CM1 = [0; 0; 0.25]; CM2 = [0; 0; 0.4]; CM3 = [0.15; 0; 0.63];
...
Thp = Thp*pi/180;
Thpp = [(rand-rand)*pi (rand-rand)*pi (rand-rand)*pi];
Thpp = [Thpp (rand-rand)*pi (rand-rand)*pi (rand-rand)*pi];
%
TwMag = [Twist; Th];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
