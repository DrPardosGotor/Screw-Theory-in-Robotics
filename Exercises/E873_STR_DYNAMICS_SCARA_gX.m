...
%
%
% FIRST we solve the exercise as showed by Murray:
%
% M(t) Inertia Matrix.
...
Nt11 = PoAcc(1)*(mass(1)*l1/2+mass(2)*l1+mass(3)*l1+mass(4)*l1)*cos(Th(1));
Nt11 = Nt11 + PoAcc(1)*(mass(2)*l2/2+mass(3)*l2+mass(4)*l2)*cos(Th(1)+Th(2));
Nt21 = PoAcc(1)*(mass(2)*l2/2+mass(3)*l2+mass(4)*l2)*cos(Th(1)+Th(2));
NtM = [Nt11; Nt21; 0; 0];
%
