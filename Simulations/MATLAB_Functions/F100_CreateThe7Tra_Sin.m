%% Function "F100_CreateThe7Tra_Sin"
% Generation of Trajectories for SEVEN Joints (shape SIN).
% Trajectories intended for Forward Kinematics Exercises and Simulations
%
% by Dr. Pardos-Gotor ST24R "Screw Theory Toolbox for Robotics" MATLAB.
%
% function TrajOut = F100_CreateThe7Tra_Sin(Themax, Thmin, tsample, tratime)
%
% INPUTS:
% Themax (1x7) rad maximum values for the Joint magnitudes.
% Themin (1x7) rad minimum values for the Joint magnitudes.
...
% TrajOut(8,:) = Joint7 Theta position (rad).
%
% Use case:
% Thmax = pi/180*[360 360 360 360 360 360 360]/3;
% Thmin = pi/180*[360 360 360 360 360 360 360]/3;
% F100_CreateThe7Tra_Sin(Thmax, Thmin, 0.001, 10);
%
...
%
%% F100_CreateThe7Tra_Sin
%
function TrajOut = F100_CreateThe7Tra_Sin(Themax, Themin, tsample, tratime) % #codegen
%
...
TrajOutAmp07 = (abs(Themax(7))+abs(Themin(7)))/2;
TrajOutLev07 = (Themax(7)+Themin(7))/2;
...
TrajOut(8,:) = TrajOutAmp07*sin(2*pi/tratime*TrajOut(1,:))+TrajOutLev07;
%
save('Theta7Traj_Sin', 'TrajOut','-v7.3');
%
end
%